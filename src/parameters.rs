...
pub const NUM_ITERATIONS: usize = 1000;
pub const NUM_EPISODES: usize = 400;
...
pub const DECAY_INTERVAL: usize = 60;

pub const VALUE_LOSS_WEIGHT: f32 = 0.5;
pub const WEIGHT_DECAY: f32 = 1e-4;

pub const DIRICHLET_ALPHA: f32 = 1.0;
pub const DIRICHLET_EPSILON: f32 = 0.25;

pub const TEMPERATURE_ANNEALING: usize = 12;    // 6 moves each
